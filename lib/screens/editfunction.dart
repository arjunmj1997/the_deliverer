...
class EditFunction extends StatefulWidget {
  String? uid;
  String? name;
  String? eid;


  EditFunction({Key? key,this.name,this.uid,this.eid}) : super(key: key);

  @override
  _EditFunctionState createState() => _EditFunctionState();
}

class _EditFunctionState extends State<EditFunction> {
