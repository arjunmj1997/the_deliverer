                   ...
                   //   mainAxisAlignment: MainAxisAlignment.center,
                     // crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        ...
                        AppHeadingText(text: 'Login',color: Colors.blue,size: 70,),
                            ...
                            ? GestureDetector(
                                onTap: () {
                                  ...
                                  if (loginkey.currentState!.validate()) {
                                    if(usernameControler.text=="admin@gmail.com"&&passwordController.text=="admin12345"){
                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>AdminPage()));
                                    }
                                    else{
                                    FirebaseAuth.instance.signInWithEmailAndPassword(email: usernameControler.text.trim(), password: passwordController.text.trim()).then((user) =>
                                        FirebaseFirestore.instance.collection('user').doc(user.user!.uid).get().then((value) =>  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>HomePage1(name: value.data()!['name'],
                        ...
                        GestureDetector(
                          onTap: (){
                            ...
                            child: AppNormalText(text:"Create an account?", color: Colors.blue,
                                size: 25,
                                fw: FontWeight.w500))
                      ],
                    ),
